...
void sortIntegers(int* array, unsigned int size){
	...
	//Compare temp2 with each number before it and if that number is larger, swap those numbers,
	//and repeat until a smaller number is found.
	for (int i = 1; i < size; i++){
		temp2 = array[i];
		j = i - 1;
		while (j >= 0 && array[j] > temp2){
